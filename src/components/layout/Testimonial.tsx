...
export const Testimonial = forwardRef<HTMLDivElement, TestimonialProps>(
  ({ variant = 'default', layout = 'vertical', className, children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
...
export const TestimonialQuote = forwardRef<HTMLQuoteElement, TestimonialQuoteProps>(
  ({ className, children, showQuotes = true, ...props }, ref) => {
    return (
      <blockquote
        ...
        {...props}
      >
        {showQuotes && '"'}{children}{showQuotes && '"'}
      </blockquote>
    )
  }
)
...
export const TestimonialAvatar = forwardRef<HTMLDivElement, TestimonialAvatarProps>(
...
export const TestimonialName = forwardRef<HTMLParagraphElement, TestimonialNameProps>(
  ({ className, children, ...props }, ref) => {
    return (
      <p
        ref={ref}
...
export const TestimonialRole = forwardRef<HTMLParagraphElement, TestimonialRoleProps>(
  ({ className, children, ...props }, ref) => {
    return (
      <p
        ref={ref}
