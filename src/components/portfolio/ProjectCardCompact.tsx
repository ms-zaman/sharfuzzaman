...
import { getCategoryDisplayName, getProjectStatusColor } from '~/utils/portfolio'
...
export const ProjectCardCompact = forwardRef<HTMLDivElement, ProjectCardCompactProps>(
            ...
            <div className="flex-1 min-w-0">
              ...
              <Link to={`/projects/${project.slug}`}>
                <span className="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-700 transition-colors">
                  View Project
                  <ArrowRightIcon size="sm" className="ml-1 group-hover:translate-x-1 transition-transform" />
                </span>
              </Link>
            </div>
